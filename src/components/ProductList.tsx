...
const ProductList: React.FC = () => {
  ...
  // ✅ Stop background scrolling when editing modal is open
  useEffect(() => {
    document.body.style.overflow = editingProduct ? 'hidden' : 'auto';
    return () => {
      document.body.style.overflow = 'auto';
    };
  }, [editingProduct]);
                  ...
                  >
                    ...
                    <td className="px-4 py-5 flex gap-2 justify-center items-center">
                      <button
                        ...
                        className="text-blue-600 border border-blue-600 hover:bg-blue-600 hover:text-white px-2 py-1 text-sm rounded transition duration-200"
                      >
                        👁️
                      </button>
                      <button
                        onClick={() => setEditingProduct(product)}
                        className="text-green-600 border border-green-600 hover:bg-green-600 hover:text-white px-2 py-1 text-sm rounded transition duration-200"
                      >
                        ✏️
                      </button>
                      <button
                        onClick={() => handleDelete(product.id)}
                        className="text-red-600 border border-red-600 hover:bg-red-600 hover:text-white px-2 py-1 text-sm rounded transition duration-200"
                      >
                        🗑️
                      </button>
                    </td>
